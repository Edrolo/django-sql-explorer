...
EXPLORER_LOGIN_URL                      Set to the URL of a login page if you want users to be redirected when they are not allowed to view a page.     None  # By default, a basic login view is provided and users are not redirected.
